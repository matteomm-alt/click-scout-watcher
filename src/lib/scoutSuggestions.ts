...
export function suggestNextTouch(
  ...
  switch (prevSkill) {
    ...
    case 'A':
      ...
      // Attacco non conclusivo (difeso/rigiocato): la palla passa alla
      // squadra avversaria, che riparte in FASE DI ATTACCO. Pre-selezioniamo
      // Attacco (A) per l'avversario: l'operatore può comunque cambiare
      // fondamentale (Muro/Difesa) prima di confermare il tocco.
