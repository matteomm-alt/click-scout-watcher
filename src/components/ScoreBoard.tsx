    ...
    <div className="glass rounded-xl px-6 py-3 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="text-[10px] px-2 py-1 rounded-md bg-secondary/60 hover:bg-secondary text-muted-foreground hover:text-foreground transition-colors uppercase tracking-wider font-bold"
          title="Time-out Casa"
        >
          T-out
        </button>
      ...
      <Dialog open={sanctionOpen} onOpenChange={setSanctionOpen}>
        <DialogTrigger asChild>
          <button
            type="button"
            className="px-2 py-1 rounded-md bg-secondary/60 hover:bg-secondary text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1 text-[11px] font-bold uppercase tracking-wider"
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(Object.keys(sanctionMeta) as SanctionType[]).map((t) => (
                  <button
                    ...
                    className={`flex items-center gap-2 py-2 px-3 rounded-md text-xs font-bold transition-all ${
            ...
            <div className="flex gap-2 pt-2">
              <Button variant="outline" className="flex-1" onClick={() => setSanctionOpen(false)}>
                Annulla
              </Button>
              <Button className="flex-1" onClick={submitSanction}>
                Registra
              </Button>
            </div>
          </div>
